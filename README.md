...
[![check](https://trev.zip/llc/stack/actions/workflows/check.yaml/badge.svg?branch=main&logo=forgejo&logoColor=%23bac2de&label=check&labelColor=%23313244)](https://trev.zip/trev/stack/actions?workflow=check.yaml)
[![vulnerable](https://trev.zip/llc/stack/actions/workflows/vulnerable.yaml/badge.svg?branch=main&logo=forgejo&logoColor=%23bac2de&label=vulnerable&labelColor=%23313244)](https://trev.zip/trev/stack/actions?workflow=vulnerable.yaml)
