...
const file_number_v1_list_proto_rawDesc = "" +
	...
	"\x06number\x18\x03 \x01(\rB\v\xbaH\b*\x06\x18\xc0\x84=(\x00R\x06number\"\xfe\x02\n" +
	"\vListRequest\x12\x1b\n" +
	"\x06cursor\x18\x01 \x01(\x03H\x00R\x06cursor\x88\x01\x01\x12\"\n" +
	"\x04name\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x182H\x01R\x04name\x88\x01\x01\x12\"\n" +
	...
	"\x03end\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampH\x05R\x03end\x88\x01\x01:F\xbaHC\x1aA\n" +
	"\x0fend_after_start\x12\x17End must be after start\x1a\x15this.end > this.startB\t\n" +
	"\a_cursorB\a\n" +
	"\x05_nameB\x06\n" +
	"\x04_minB\x06\n" +
	"\x04_maxB\b\n" +
